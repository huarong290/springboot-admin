...
public class AuthController {
    ...
    public ApiResult<TokenResDTO> login(@RequestBody @Validated UserLoginReqDTO dto, HttpServletRequest request) {
        // 安全填充 IP 地址
    ...
    @Loggable(logRequest = true, logResponse = true)
    public ApiResult<TokenResDTO> refresh(@RequestBody @Validated TokenRefreshReqDTO dto,HttpServletRequest request) {
       // 安全填充 IP 地址
        String clientIp = IpUtil.getClientIp(request);
        dto.setLoginIp(clientIp);
